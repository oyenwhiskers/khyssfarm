...
<div class="row">
    ...
    <div class="col-12 mb-3">
        <h5 class="text-primary">
            <i class="fas fa-seedling me-2"></i>Farm Production
        </h5>
    </div>
    ...
    <div class="col-lg-2 col-md-4 col-sm-6 mb-4">
        <div class="card metric-card">
            <div class="card-body text-center">
                <i class="fas fa-weight fa-2x mb-3 text-primary"></i>
                <h3 class="mb-1">{{ number_format($totalYield, 2) }} kg</h3>
                <p class="mb-0">Farm Yield</p>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-2 col-md-4 col-sm-6 mb-4">
        <div class="card metric-card revenue">
            <div class="card-body text-center">
                ...
                <h3 class="mb-1">RM{{ number_format($farmRevenue, 2) }}</h3>
                <p class="mb-0">Farm Revenue</p>
                @if($pendingRevenue > 0)
                    <small class="text-warning">+RM{{ number_format($pendingRevenue, 2) }} pending</small>
                @endif
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-2 col-md-4 col-sm-6 mb-4">
        <div class="card metric-card profit">
            <div class="card-body text-center">
                ...
                <h3 class="mb-1 {{ $farmProfit >= 0 ? '' : 'text-warning' }}">RM{{ number_format($farmProfit, 2) }}</h3>
                <p class="mb-0">Farm Profit</p>
            </div>
        </div>
    </div>
    
    <!-- Resell Metrics Section -->
    <div class="col-12 mb-3 mt-4">
        <h5 class="text-success">
            <i class="fas fa-exchange-alt me-2"></i>Resell Business
        </h5>
    </div>
    ...
    <div class="col-lg-2 col-md-4 col-sm-6 mb-4">
        <div class="card metric-card">
            <div class="card-body text-center">
                ...
                <h3 class="mb-1">{{ number_format($resellYield, 2) }} kg</h3>
                <p class="mb-0">Resell Yield</p>
    ...
    <div class="col-lg-2 col-md-4 col-sm-6 mb-4">
        <div class="card metric-card revenue">
            <div class="card-body text-center">
                ...
                <h3 class="mb-1">RM{{ number_format($resellRevenue, 2) }}</h3>
                <p class="mb-0">Resell Revenue</p>
            </div>
        </div>
    </div>
    
    <!-- Resell Purchase Costs -->
    <div class="col-lg-2 col-md-4 col-sm-6 mb-4">
        <div class="card metric-card cost">
            <div class="card-body text-center">
                <i class="fas fa-shopping-cart fa-2x mb-3"></i>
                <h3 class="mb-1">RM{{ number_format($totalAllCosts - $totalCosts, 2) }}</h3>
                <p class="mb-0">Purchase Costs</p>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-2 col-md-4 col-sm-6 mb-4">
        <div class="card metric-card profit">
            <div class="card-body text-center">
                ...
                <h3 class="mb-1 {{ $resellProfit >= 0 ? '' : 'text-warning' }}">RM{{ number_format($resellProfit, 2) }}</h3>
                <p class="mb-0">Resell Profit</p>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-3 col-md-6 mb-4">
        <div class="card metric-card revenue">
            <div class="card-body text-center">
                ...
                <small class="text-muted">Farm + Resell</small>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-3 col-md-6 mb-4">
        <div class="card metric-card cost">
            <div class="card-body text-center">
                ...
                <h3 class="mb-1">RM{{ number_format($totalAllCosts, 2) }}</h3>
                <p class="mb-0">Total Costs</p>
                <small class="text-muted">All Operations</small>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-3 col-md-6 mb-4">
        <div class="card metric-card profit">
            <div class="card-body text-center">
                ...
                <h3 class="mb-1 {{ $grandTotalProfit >= 0 ? 'text-success' : 'text-danger' }}">RM{{ number_format($grandTotalProfit, 2) }}</h3>
    ...
    <div class="col-lg-3 col-md-6 mb-4">
        <div class="card metric-card">
            <div class="card-body text-center">
                ...
                @php
                    $profitMargin = $totalRevenue > 0 ? ($grandTotalProfit / $totalRevenue) * 100 : 0;
                @endphp
                <h3 class="mb-1 {{ $profitMargin >= 0 ? 'text-success' : 'text-danger' }}">{{ number_format($profitMargin, 1) }}%</h3>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="text-center p-3 border rounded bg-success bg-opacity-10">
                            ...
                            <h4 class="text-success">RM{{ number_format($farmProfit, 2) }}</h4>
                            <p class="mb-0 fw-bold">Farm Operations Profit</p>
                            <small class="text-muted">From own harvest sales</small>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="text-center p-3 border rounded bg-info bg-opacity-10">
                            <i class="fas fa-exchange-alt fa-2x text-info mb-2"></i>
                            <h4 class="text-info">RM{{ number_format($resellProfit, 2) }}</h4>
                            <p class="mb-0 fw-bold">Resell Trading Profit</p>
                            <small class="text-muted">From supplier purchases resale</small>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="text-center p-3 border rounded bg-primary bg-opacity-10">
                            <i class="fas fa-trophy fa-2x text-primary mb-2"></i>
                            <h4 class="text-primary">RM{{ number_format($grandTotalProfit, 2) }}</h4>
                            <p class="mb-0 fw-bold">Combined Total Profit</p>
                            <small class="text-muted">All business operations</small>
                        </div>
                    </div>
                </div>
            </div>
