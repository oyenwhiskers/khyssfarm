...
@section('title', 'New Harvest Record')
@section('page-title', 'Record New Harvest')
    ...
    <div class="col-lg-8 mx-auto">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0"><i class="fas fa-seedling me-2"></i>New Harvest Record</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('harvests.store') }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" class="form-control @error('harvest_date') is-invalid @enderror" 
                                   id="harvest_date" name="harvest_date" value="{{ old('harvest_date', today()->toDateString()) }}" required>
                            @error('harvest_date')
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" step="0.01" min="0" class="form-control @error('quantity_kg') is-invalid @enderror" 
                                   id="quantity_kg" name="quantity_kg" value="{{ old('quantity_kg') }}" required>
                            @error('quantity_kg')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('field_location') is-invalid @enderror" 
                                   id="field_location" name="field_location" value="{{ old('field_location') }}" 
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('notes') is-invalid @enderror" 
                                  ...
                                  placeholder="Any additional notes about this harvest...">{{ old('notes') }}</textarea>
                        @error('notes')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
