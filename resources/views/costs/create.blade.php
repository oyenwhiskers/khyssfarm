...
@section('title', 'New Cost Record')
@section('page-title', 'Record New Cost')
    ...
    <div class="col-lg-8 mx-auto">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0"><i class="fas fa-receipt me-2"></i>New Cost Record</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('costs.store') }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" class="form-control @error('date') is-invalid @enderror" 
                                   id="date" name="date" value="{{ old('date', today()->toDateString()) }}" required>
                            @error('date')
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('notes') is-invalid @enderror" 
                                  ...
                                  placeholder="Any additional notes about this cost...">{{ old('notes') }}</textarea>
                        @error('notes')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <button type="submit" class="btn btn-warning">
                            <i class="fas fa-save me-2"></i>Save Cost Record
                        </button>
                    </div>
                </form>
            </div>
